...
base_model=VGG16(weights="imagenet",include_top=False,input_tensor=(128,128,3))
print(base_model.sumary())
...
# Hyper parameters
print_time = 1000  # interval for evaluating on one-shot tasks
save_time=50000
batch_size = 32
n_iter = 800000  # No. of training iterations
...
def train():
	...
	for i in range(1, n_iter + 1):
		...
		if i%save_time==0:
			network_train.save("step-{}_loss-{:.5f}.h5".format(i,loss))
		# fpr, tpr, thresholds,auc = compute_metrics(probs,yprob)
		# draw_roc(fpr, tpr)
